...
public class InventoryHelmet : MonoBehaviour
{
    public GameObject[] _items = new GameObject[InventoryConstants.MAX_HELMET];
    ...
    {
        InventoryManager.Instance._helmetCreateItem = true;
        for (int i = 0; i < InventoryConstants.MAX_HELMET; i++)
        {
    ...
    {
        cleanItem();
        List<RtItem> _rtItems = InventoryManager.Instance._rtItemsHelmet;
